# JSON Schema Generator API - Examples

This folder contains example code for using the JSON Schema Generator API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/jsonschemagenerator',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/jsonschemagenerator");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/jsonschemagenerator](https://docs.apiverve.com/ref/jsonschemagenerator)
