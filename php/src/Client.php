...
namespace APIVerve\Jsonschemagenerator;
...
/**
 * Client for the JSON Schema Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/jsonschemagenerator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/jsonschemagenerator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\JsonschemageneratorClient] {$message}\n";
        }
    }
}
