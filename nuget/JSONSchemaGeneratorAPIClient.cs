...
namespace APIVerve.API.JSONSchemaGenerator
{
    ...
    /// <summary>
    /// Client for the JSONSchemaGenerator API
    /// </summary>
    public class JSONSchemaGeneratorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/jsonschemagenerator";
        ...
        {
            { "json", new ValidationRule { Type = "object", Required = true } },
            { "title", new ValidationRule { Type = "string", Required = false } },
            { "description", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        public JSONSchemaGeneratorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public JSONSchemaGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public JSONSchemaGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, JSONSchemaGeneratorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(JSONSchemaGeneratorQueryOptions options)
        {
        ...
        public ResponseObj Execute(JSONSchemaGeneratorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(JSONSchemaGeneratorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(JSONSchemaGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(JSONSchemaGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(JSONSchemaGeneratorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(JSONSchemaGeneratorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(JSONSchemaGeneratorQueryOptions options)
        {
