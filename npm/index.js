...
class jsonschemageneratorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/jsonschemagenerator');
        }
        ...
        this.validationRules = {"json":{"type":"object","required":true},"title":{"type":"string","required":false,"default":"Generated Schema"},"description":{"type":"string","required":false}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/jsonschemagenerator`);
        }
    }
...
module.exports = jsonschemageneratorWrapper;
