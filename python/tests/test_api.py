...
class TestJsonschemageneratorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = JsonschemageneratorAPIClient(self.api_key)

    @patch('apiverve_jsonschemagenerator.apiClient.requests.get')
