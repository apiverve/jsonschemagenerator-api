// Package jsonschemagenerator provides a Go client for the JSON Schema Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/jsonschemagenerator?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the JSON Schema Generator API.
//
// Parameters:
//   - json (required): object - The sample JSON data to generate a schema from
//   - title: string - The title for the generated schema (default: 'Generated Schema')
...
// ResponseData contains the data returned by the JSON Schema Generator API.
type ResponseData struct {
	Schema SchemaData `json:"schema"`
	SampleData SampleDataData `json:"sample_data"`
}

// SchemaData represents the schema object.
...
// ActiveData represents the active object.
type ActiveData struct {
	Type string `json:"type"`
}

// SampleDataData represents the sample_data object.
type SampleDataData struct {
