# JSON Schema Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:jsonschemagenerator-api:1.1.12'
}
```
...
```java
import com.apiverve.jsonschemagenerator.JSONSchemaGeneratorAPIClient;
import com.apiverve.jsonschemagenerator.APIResponse;
import com.apiverve.jsonschemagenerator.APIException;

// Initialize the client
JSONSchemaGeneratorAPIClient client = new JSONSchemaGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/jsonschemagenerator](https://docs.apiverve.com/ref/jsonschemagenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/jsonschemagenerator](https://docs.apiverve.com/ref/jsonschemagenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/jsonschemagenerator-api/issues)
